...
listProperty=list(set(fileData['OMSCH']))
...
#
#root = Tk()
#checkBoxBar = Checkbar(root, listProperty)
#
#checkBoxBar.pack(side=TOP,  fill=Y)
#
...
#    state(self)
#
#Button(root, text='Confirm', command=allstates).pack(side=RIGHT)
#root.mainloop()
